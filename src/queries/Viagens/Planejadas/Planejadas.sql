...
BEGIN
  -- Tests realizados sem o agency_name
  -- feed_version rows    seconds
  -- 2024-10-31   2677525 7s
  -- 2024-11-01   2677525 4s
  -- 2024-11-31   1187143 Xs
  -- 2024-11-15   2381202 7s
  -- 2024-11-10   2381202 7s
  -- 2024-11-05   2677525 7s
  -- 2024-11-07   2381202 8s
  -- 2024-11-06   2677525 7s      <<< Escolha do feed_version conforme linhas inalteradas.
  ...
  temp_end_Viagens_Planejadas AS (
    SELECT 
      DISTINCT
      ROW_NUMBER() OVER (PARTITION BY trip_id ORDER BY iteration) AS row_id, 
      * 
      FROM temp_EXP_Viagens_Planejadas 
    ORDER BY iteration
  ),
